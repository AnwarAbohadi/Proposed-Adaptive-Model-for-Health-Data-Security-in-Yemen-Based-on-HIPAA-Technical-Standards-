...
\begin{document}
	...
	% 2. الفهارس التلقائية
	\tableofcontents   % فهرس المحتويات
	\listoffigures    % فهرس الأشكال (سيظهر تلقائياً عند إضافة صور)
	\listoftables     % فهرس الجداول (سيظهر تلقائياً عند إضافة جداول)
	\newpage
	
	% --- متن المقترح البحثي ---
	\pagenumbering{arabic} % إعادة ضبط الترقيم إلى الأرقام العربية (1, 2, 3) لمتن البحث
	
	% --- الفصل الأول ---
	\chapter{Introduction} % العناوين الكبرى (الفصول)
	...
	\section{Problem Statement} % العناوين الفرعية الأولى
	...
	\section{Purpose Statement} % العناوين الفرعية الثانية
